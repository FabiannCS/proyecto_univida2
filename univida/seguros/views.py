# en seguros/views.py - VERSIÓN CORREGIDA
...
# Serializers
# En seguros/views.py - actualiza el import:
from .serializers import (
    ...
    UsuarioAgenteSerializer, SiniestroSerializer, CrearSiniestroSerializer, ActualizarSiniestroSerializer,  # ← AÑADIDO
...
def aprobar_siniestro(request, siniestro_id):
    ...
    if not monto_aprobado:
        return Response(
            {'error': 'Debe especificar el monto aprobado'},
    ...
    try:
        ...
        return Response(
            {'error': f'Error al aprobar siniestro: {str(e)}'},
...
def rechazar_siniestro(request, siniestro_id):
    ...
    try:
        ...
        return Response(
            {'error': f'Error al rechazar siniestro: {str(e)}'},
            status=status.HTTP_500_INTERNAL_SERVER_ERROR
        )