"""
Django settings for univida project.
...
SECRET_KEY = 'django-insecure-cqk%^c!@d3w7n-)ezxv)nc7&chc)d-d0sv!64jnw*z@hl0zjvf'
...
WSGI_APPLICATION = 'univida.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'univida',  # Nueva BD con nombre diferente
        'USER': 'Support',
        'PASSWORD': 'soporte123',
        'HOST': 'localhost',
        'PORT': '5432',
...
AUTH_USER_MODEL = 'seguros.Usuario'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=30),  # <- 30 minutos igual que el frontend
